...
import { FaStar, FaMapMarkerAlt } from "react-icons/fa"; // Importing icons from react-icons
    ...
    <div className="px-20">
      ...
      <div className="flex flex-wrap justify-center gap-6">
        {cardsData.map((card, index) => (
          <div
            key={index}
            className="w-72 bg-white rounded-lg shadow-md overflow-hidden transform transition-transform hover:scale-105"
          >
            <img
              src={card.image}
